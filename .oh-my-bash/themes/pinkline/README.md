...
A pastel-ish theme that shows information about your shell session.

Derived from the Powerline theme from oh-my-bash.
...
* Battery charging status (depends on the oh-my-bash battery plugin)
...
> "yeah, i can confirm" - Waylake, 2026
