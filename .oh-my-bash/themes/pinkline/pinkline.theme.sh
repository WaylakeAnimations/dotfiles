...
source "$OSH/themes/pinkline/pinkline.base.sh"

PROMPT_CHAR=${POWERLINE_PROMPT_CHAR:=""}
POWERLINE_LEFT_SEPARATOR=${POWERLINE_LEFT_SEPARATOR:=""}

USER_INFO_SSH_CHAR=${POWERLINE_USER_INFO_SSH_CHAR:=" "}
USER_INFO_THEME_PROMPT_COLOR=205
USER_INFO_THEME_PROMPT_SECONDARY_COLOR=231
...
SCM_GIT_TEXT_COLOR=15
SCM_NONE_CHAR=""
SCM_GIT_CHAR=${POWERLINE_SCM_GIT_CHAR:=" "}
SCM_THEME_PROMPT_CLEAN=""
SCM_THEME_PROMPT_DIRTY=""
SCM_THEME_PROMPT_CLEAN_COLOR=212
...
CWD_THEME_PROMPT_COLOR=225
CWD_THEME_TEXT_COLOR=199

PROMPT_TEXT_COLOR=225

LAST_STATUS_THEME_PROMPT_COLOR=212
