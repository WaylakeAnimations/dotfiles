...
local settings = " targetOpacity=" .. opacity .. " similarity=0.2 amount=0.2"

local gtk_bkg = " bkg=[0.0745098039 0.0823529411 0.1019607843]"
local gtk_matches = "(engrampa|nwg-look|org.xfce.mousepad)"
...
hl.window_rule({ match = { class = "lmms.real" },
    ["darkwindow:shade"] = "chromakey bkg=[0.1490196078 0.1686274509 0.1882352941]" .. settings })

hl.window_rule({ match = { class = "obsidian" },
    ["darkwindow:shade"] = "chromakey bkg=[0.1490196078 0.1490196078 0.1490196078]" .. settings })
